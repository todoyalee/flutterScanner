...
class MRZ {
  ...
  factory MRZ.fromJson(Map<String, dynamic> json) {
    return MRZ(
      type: json['type'],
  ...
  static MRZ parseTwoLines(String line1, String line2) {
    MRZ mrzInfo = MRZ();
  ...
  static MRZ parseThreeLines(String line1, String line2, String line3) {
    MRZ mrzInfo = MRZ();
    String type = line1.substring(0, 1);
    RegExp exp = RegExp(r'[I|P|V]');
    RegExpMatch? match = exp.firstMatch(type);
